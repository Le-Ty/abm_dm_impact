...
def data_magic(g_a_d, g_a_n, g_n_d, g_n_n, d_a_d, d_a_n, d_n_d, d_n_n, outdir):
    df_gt= df_ngt =df_gt_na= df_ngt_na= df_gt_a= df_ngt_a= df_a=df_na= df_dec = df_ndec =df_dec_gt= df_dec_ngt=df_ndec_gt= df_ndec_ngt = df_dec_na = df_ndec_na = df_dec_a = df_ndec_a = pd.DataFrame()
    ...
    all_dfs_combi_name = ['dfs_gt', 'dfs_gt_na', 'dfs_gt_a', 'dfs_a', 'dfs_a_gt', 'dfs_a_gt', 'dfs_a_ngt','dfs_dec', 'dfs_dec_ngt', 'dfs_dec_gt', 'dfs_dec_na', 'dfs_dec_a' ]


    for i,j in zip(all_dfs_combi,all_dfs_combi_name ):

        filename =  (outdir +  '/' + j+ '.pkl')
...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", "--out", default= None, help = "out")
    ...
    data_magic(g_a_d, g_a_n, g_n_d, g_n_n, d_a_d, d_a_n, d_n_d, d_n_n, outdir)
